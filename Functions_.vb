...
Module Functions
    ...
    Function MJDtoGreg(ByRef epoch As String) As String
        ...
        EpochDate = CDate(JJ & "/" & MM & "/" & AAAA).ToString("dd/MM/yyyy")
        ...
        EpochTime = CDate(HH & ":" & MM3 & ":" & SS3).ToString("HH:mm:ss.fff")
    ...
    Function HtoHMS(ByVal Time As String)
        ...
        ChaineTime = CDate(HH & ":" & MM & ":" & SS).ToString("HH:mm:ss.fff")
        Time = ChaineTime
        Return Time
    ...
    Function MJDGGEHour(ByVal MJDate As Double) As String
        ...
        EpochTime = CDate(HH & ":" & MM3 & ":" & SS3).ToString("HH:mm:ss")
    ...
    Function CurrentDateToGreg()
        ...
        CurrentDateToGreg = DD & "/" & MM & "/" & AA & " " & HH & ":" & MI & ":" & SS
    ...
    Sub AdpatedParameters()
        ...
        If Home.ECC < 0.1 AndAlso Home.INC < 1 AndAlso Home.INC > -1 Then
            ...
            Home.MeanL_ECCINC.Text = Round4((Home.AOP + Home.RAAN + Home.MA) Mod 360)
        ...
        ElseIf Home.ECC < 0.1 Then
            ...
            Home.AlphaPrime.Text = Round4((Home.AOP + Home.MA) Mod 360)
